...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'users.user': {
            ...
            'following': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'followers'", 'blank': 'True', 'db_table': "'user_relationship'", 'to': u"orm['users.User']"}),
